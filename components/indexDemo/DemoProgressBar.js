...
<Container maxWidth="xl" sx={{mt: 2, px:2, py:3, bgcolor: '#353C42', borderRadius: 2}}>
    ...
    <Stack direction="row" alignItems="center" justifyContent="flex-end" sx={{mr:{md:25}, mt:5}}>
    ...
    <Stack direction="column" alignItems="center" justifyContent="center" spacing={2} sx={{mt:5}}>
      ...
      <Button sx={{ml:{xs:2, sm:2}}} href="q&a/private/" variant="contained" color="green">
        Specialists
      </Button></Typography> 
      </Stack>
      </TabPanel>
 ...
 <Container>
      <Stack direction="row" alignItems="center" justifyContent="center">
        <Typography sx={{mb:4,color:'background.contrastColor', textDecoration:'underline', textDecorationColor:"#52d17b", display:'inline'}} variant="h4">10 steps to follow for determining the safety of a website:</Typography>
      </Stack>
...
<Stack direction="column" alignItems="center" justifyContent="center" spacing={5}>
        ...
        <Stack direction="row" alignItems="center" justifyContent="flex-end" sx={{mr:{md:50}, mt:5}}>
